...
<h1 class="titre"><a href="https://www.nps.gov/yell/index.htm">Yellowstone</a></h1>
...
?>
			...
			<input type="text" required placeholder="Nouveau mot de passe (5 caractères minimum)"  name="password" value="<?php echo $password ?>">
